...
Object.assign(exports, {
    ...
    convert: (coclass, header, impl, options = {}) => {
        ...
        const interface = coclass.interface;
        const wtype = interface === "IDispatch" ? "DISPATCH" : "UNKNOWN";
        ...
        header.push(`
            ...
            extern const HRESULT autoit_from(I${ cotype }*& in_val, ${ interface }**& out_val);
        ...
        impl.push(`
            ...
            const HRESULT autoit_from(I${ cotype }*& in_val, ${ interface }**& out_val) {
                *out_val = static_cast<${ interface }*>(in_val);
                in_val->AddRef();
                return S_OK;
            }
            ...
            const HRESULT autoit_from(I${ cotype }*& in_val, VARIANT*& out_val) {
                ...
                V_${ wtype }(out_val) = static_cast<${ interface }*>(in_val);
                in_val->AddRef();
                return S_OK;
            }
            `.replace(/^ {12}/mg, "")
        ...
        header.push(`
            ...
            extern const HRESULT autoit_from(const ${ shared_ptr }<${ coclass.fqn }>& in_val, ${ interface }**& out_val);
        `.replace(/^ {12}/mg, ""));
        ...
        impl.push(`
            ...
            const HRESULT autoit_from(const ${ shared_ptr }<${ coclass.fqn }>& in_val, ${ interface }**& out_val) {
            ...
            impl.push(`
                const HRESULT autoit_from(const ${ shared_ptr }<${ coclass.fqn }>& in_val, VARIANT*& out_val) {
                    ...
                    if (SUCCEEDED(hr)) {
                        VariantClear(out_val);
                        V_VT(out_val) = VT_${ wtype };
                        V_${ wtype }(out_val) = static_cast<${ interface }*>(*ppdispVal);
                    }
                    return hr;
                }
            `.replace(/^ {16}/mg, ""));
        ...
        if (coclass.is_simple || coclass.is_struct || coclass.is_map || coclass.has_copy_constructor || coclass.has_assign_operator) {
            ...
            header.push(`
                ...
                extern const bool is_assignable_from(${ coclass.fqn }& out_val, ${ interface }*& in_val, bool is_optional);

                extern const HRESULT autoit_to(I${ cotype }*& in_val, ${ coclass.fqn }& out_val);
                extern const HRESULT autoit_to(${ interface }*& in_val, ${ coclass.fqn }& out_val);

                extern const HRESULT autoit_from(const ${ coclass.fqn }& in_val, I${ cotype }**& out_val);
                extern const HRESULT autoit_from(const ${ coclass.fqn }& in_val, ${ interface }**& out_val);
            `.replace(/^ {16}/mg, "").trim());
            impl.push(`
                ...
                const bool is_assignable_from(${ coclass.fqn }& out_val, ${ interface }*& in_val, bool is_optional) {
                ...
                const HRESULT autoit_to(${ interface }*& in_val, ${ coclass.fqn }& out_val) {
                    auto obj = dynamic_cast<C${ cotype }*>(in_val);
                    out_val = *obj->__self->get();
                    return S_OK;
                }
                ...
                const HRESULT autoit_from(const ${ coclass.fqn }& in_val, ${ interface }**& out_val) {
                    return autoit_from(in_val, reinterpret_cast<I${ cotype }**&>(out_val));
                }
                `.replace(/^ {16}/mg, "")
            );
