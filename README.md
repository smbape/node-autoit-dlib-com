...
## Prerequisites
  ...
  - Download and extract [autoit-dlib-19.24.0-opencv-4.6.0-com-v1.2.0.7z](https://github.com/smbape/node-autoit-dlib-com/releases/download/v1.2.0/autoit-dlib-19.24.0-opencv-4.6.0-com-v1.2.0.7z) into a folder
...
```sh
# download autoit-dlib-19.24.0-opencv-4.6.0-com-v1.2.0.7z
curl -L 'https://github.com/smbape/node-autoit-dlib-com/releases/download/v1.2.0/autoit-dlib-19.24.0-opencv-4.6.0-com-v1.2.0.7z' -o autoit-dlib-19.24.0-opencv-4.6.0-com-v1.2.0.7z

# extract the content of autoit-dlib-19.24.0-opencv-4.6.0-com-v1.2.0.7z into a folder named autoit-dlib-com
7z x autoit-dlib-19.24.0-opencv-4.6.0-com-v1.2.0.7z -aoa -oautoit-dlib-com
...
# download autoit-dlib-19.24.0-opencv-4.6.0-com-v1.2.0-src.zip
curl -L 'https://github.com/smbape/node-autoit-dlib-com/archive/refs/tags/v1.2.0.zip' -o autoit-dlib-19.24.0-opencv-4.6.0-com-v1.2.0-src.zip

# extract the examples folder of autoit-dlib-19.24.0-opencv-4.6.0-com-v1.2.0-src.zip
7z x autoit-dlib-19.24.0-opencv-4.6.0-com-v1.2.0-src.zip -aoa 'node-autoit-dlib-com-1.2.0\examples'
