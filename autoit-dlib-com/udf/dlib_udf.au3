...
Func _Dlib_Install($s_dlib_wolrd_dll = Default, $s_autoit_dlib_com_dll = Default, $bUser = Default, $bOpen = True, $bClose = True, $bInstall = False, $bUninstall = False)
	...
	If $bOpen Then
		...
		If $h_autoit_dlib_com_dll == -1 Then Return False
...
Func _Dlib_Params($sKey1 = Default, $vVal1 = Default, $sKey2 = Default, $vVal2 = Default, $sKey3 = Default, $vVal3 = Default, $sKey4 = Default, $vVal4 = Default, $sKey5 = Default, $vVal5 = Default, $sKey6 = Default, $vVal6 = Default, $sKey7 = Default, $vVal7 = Default, $sKey8 = Default, $vVal8 = Default, $sKey9 = Default, $vVal9 = Default, $sKey10 = Default, $vVal10 = Default, $sKey11 = Default, $vVal11 = Default, $sKey12 = Default, $vVal12 = Default, $sKey13 = Default, $vVal13 = Default, $sKey14 = Default, $vVal14 = Default, $sKey15 = Default, $vVal15 = Default, $sKey16 = Default, $vVal16 = Default, $sKey17 = Default, $vVal17 = Default, $sKey18 = Default, $vVal18 = Default, $sKey19 = Default, $vVal19 = Default, $sKey20 = Default, $vVal20 = Default, $sKey21 = Default, $vVal21 = Default, $sKey22 = Default, $vVal22 = Default, $sKey23 = Default, $vVal23 = Default, $sKey24 = Default, $vVal24 = Default, $sKey25 = Default, $vVal25 = Default, $sKey26 = Default, $vVal26 = Default, $sKey27 = Default, $vVal27 = Default, $sKey28 = Default, $vVal28 = Default, $sKey29 = Default, $vVal29 = Default, $sKey30 = Default, $vVal30 = Default)
	; console.log(Array.from(Array(30).keys()).map(j => `
	; Case ${ 2 * (j + 1) }
	;     Return _Dlib_ObjCreate("MapOfStringAndVariant").create(_Dlib_Tuple(${ Array.from(Array(j + 1).keys()).map(i => `_Dlib_Tuple($sKey${ i + 1 }, $vVal${ i + 1 })`).join(", ") }))
	; `.trim()).join("\n"))
	Switch @NumParams
		Case 2
			Return _Dlib_ObjCreate("MapOfStringAndVariant").create(_Dlib_Tuple(_Dlib_Tuple($sKey1, $vVal1)))
		Case 4
			Return _Dlib_ObjCreate("MapOfStringAndVariant").create(_Dlib_Tuple(_Dlib_Tuple($sKey1, $vVal1), _Dlib_Tuple($sKey2, $vVal2)))
		Case 6
			Return _Dlib_ObjCreate("MapOfStringAndVariant").create(_Dlib_Tuple(_Dlib_Tuple($sKey1, $vVal1), _Dlib_Tuple($sKey2, $vVal2), _Dlib_Tuple($sKey3, $vVal3)))
		Case 8
			Return _Dlib_ObjCreate("MapOfStringAndVariant").create(_Dlib_Tuple(_Dlib_Tuple($sKey1, $vVal1), _Dlib_Tuple($sKey2, $vVal2), _Dlib_Tuple($sKey3, $vVal3), _Dlib_Tuple($sKey4, $vVal4)))
		Case 10
			Return _Dlib_ObjCreate("MapOfStringAndVariant").create(_Dlib_Tuple(_Dlib_Tuple($sKey1, $vVal1), _Dlib_Tuple($sKey2, $vVal2), _Dlib_Tuple($sKey3, $vVal3), _Dlib_Tuple($sKey4, $vVal4), _Dlib_Tuple($sKey5, $vVal5)))
		Case 12
			Return _Dlib_ObjCreate("MapOfStringAndVariant").create(_Dlib_Tuple(_Dlib_Tuple($sKey1, $vVal1), _Dlib_Tuple($sKey2, $vVal2), _Dlib_Tuple($sKey3, $vVal3), _Dlib_Tuple($sKey4, $vVal4), _Dlib_Tuple($sKey5, $vVal5), _Dlib_Tuple($sKey6, $vVal6)))
		Case 14
			Return _Dlib_ObjCreate("MapOfStringAndVariant").create(_Dlib_Tuple(_Dlib_Tuple($sKey1, $vVal1), _Dlib_Tuple($sKey2, $vVal2), _Dlib_Tuple($sKey3, $vVal3), _Dlib_Tuple($sKey4, $vVal4), _Dlib_Tuple($sKey5, $vVal5), _Dlib_Tuple($sKey6, $vVal6), _Dlib_Tuple($sKey7, $vVal7)))
		Case 16
			Return _Dlib_ObjCreate("MapOfStringAndVariant").create(_Dlib_Tuple(_Dlib_Tuple($sKey1, $vVal1), _Dlib_Tuple($sKey2, $vVal2), _Dlib_Tuple($sKey3, $vVal3), _Dlib_Tuple($sKey4, $vVal4), _Dlib_Tuple($sKey5, $vVal5), _Dlib_Tuple($sKey6, $vVal6), _Dlib_Tuple($sKey7, $vVal7), _Dlib_Tuple($sKey8, $vVal8)))
		Case 18
			Return _Dlib_ObjCreate("MapOfStringAndVariant").create(_Dlib_Tuple(_Dlib_Tuple($sKey1, $vVal1), _Dlib_Tuple($sKey2, $vVal2), _Dlib_Tuple($sKey3, $vVal3), _Dlib_Tuple($sKey4, $vVal4), _Dlib_Tuple($sKey5, $vVal5), _Dlib_Tuple($sKey6, $vVal6), _Dlib_Tuple($sKey7, $vVal7), _Dlib_Tuple($sKey8, $vVal8), _Dlib_Tuple($sKey9, $vVal9)))
		Case 20
			Return _Dlib_ObjCreate("MapOfStringAndVariant").create(_Dlib_Tuple(_Dlib_Tuple($sKey1, $vVal1), _Dlib_Tuple($sKey2, $vVal2), _Dlib_Tuple($sKey3, $vVal3), _Dlib_Tuple($sKey4, $vVal4), _Dlib_Tuple($sKey5, $vVal5), _Dlib_Tuple($sKey6, $vVal6), _Dlib_Tuple($sKey7, $vVal7), _Dlib_Tuple($sKey8, $vVal8), _Dlib_Tuple($sKey9, $vVal9), _Dlib_Tuple($sKey10, $vVal10)))
		Case 22
