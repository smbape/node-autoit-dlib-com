...
Func _Dlib_Install($s_dlib_world_dll = Default, $s_autoit_dlib_com_dll = Default, $bUser = Default, $bOpen = True, $bClose = True, $bInstall = False, $bUninstall = False)
	If $s_dlib_world_dll == Default Then $s_dlib_world_dll = "opencv_world4120.dll"
	If $s_autoit_dlib_com_dll == Default Then $s_autoit_dlib_com_dll = "autoit_dlib_com-20.0-4120.dll"
	...
	If $bOpen And EnvGet("OPENCV_BUILD_TYPE") == "Debug" Then
		$h_dlib_ffmpeg_dll = _Dlib_LoadDLL(StringReplace($s_dlib_world_dll, "opencv_world4120d.dll", "opencv_videoio_ffmpeg4120_64.dll"))
